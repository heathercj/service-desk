...
| Capability                             |    Customer    | Triage Agent |  Dept Agent   | Dept Manager  | Knowledge Manager | Product Manager | Administrator |
| -------------------------------------- | :------------: | :----------: | :-----------: | :-----------: | :---------------: | :-------------: | :-----------: |
| Create ticket                          |    ✅ (own)    |      --      |      --       |      --       |        --         |       --        |      --       |
| View own ticket                        |       ✅       |      --      |      --       |      --       |        --         |       --        |      ✅       |
...
| View product-signal report (all depts) |       --       |      --      |      --       |      --       |        --         |       ✅        |      ✅       |
| Manage the product-signal rubric       |       --       |      --      |      --       |      --       |        --         |       --        |      ✅       |
| View audit events                      |       --       |      --      |      --       |      --       |        --         |       --        |      ✅       |
